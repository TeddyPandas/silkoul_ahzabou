...
CREATE TYPE "public"."rhythm_level" AS ENUM (
    'SLOW',
    'MEDIUM',
    'FAST'
);
...
ALTER TYPE "public"."rhythm_level" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."add_tasks_to_subscription"("p_user_id" "uuid", "p_campaign_id" "uuid", "p_tasks" "jsonb") RETURNS "void"
...
BEGIN
  ...
  -- 2. Loop through requested Tasks
  FOR v_task IN SELECT * FROM jsonb_array_elements(p_tasks)
  LOOP
    v_task_id := (v_task->>'task_id')::UUID;
    v_quantity := (v_task->>'quantity')::INT;

    -- Lock text for update and check remaining
...
ALTER FUNCTION "public"."add_tasks_to_subscription"("p_user_id" "uuid", "p_campaign_id" "uuid", "p_tasks" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_wazifa"("p_name" "text", "p_description" "text", "p_lat" double precision, "p_lng" double precision, "p_rhythm" "public"."rhythm_level", "p_morning" time without time zone, "p_evening" time without time zone) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    new_id UUID;
...
ALTER FUNCTION "public"."create_wazifa"("p_name" "text", "p_description" "text", "p_lat" double precision, "p_lng" double precision, "p_rhythm" "public"."rhythm_level", "p_morning" time without time zone, "p_evening" time without time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_nearby_wazifas"("p_lat" double precision, "p_lng" double precision, "radius_meters" double precision DEFAULT 5000) RETURNS TABLE("id" "uuid", "name" "text", "description" "text", "address" "text", "rhythm" "public"."rhythm_level", "schedule_morning" time without time zone, "schedule_evening" time without time zone, "lat" double precision, "lng" double precision, "distance_meters" double precision)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_nearby_wazifas"("p_lat" double precision, "p_lng" double precision, "radius_meters" double precision) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."insert_test_data"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."unsubscribe_campaign"("p_campaign_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_user_id UUID;
...
ALTER FUNCTION "public"."unsubscribe_campaign"("p_campaign_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."media_videos" (
    ...
    CONSTRAINT "media_videos_status_check" CHECK (("status" = ANY (ARRAY['PENDING'::"text", 'PUBLISHED'::"text", 'ARCHIVED'::"text"])))
);
...
ALTER TABLE "public"."podcast_shows" OWNER TO "postgres";
...
ALTER TABLE "public"."silsila_relations" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tasks" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "tasks_remaining_number_check" CHECK (("remaining_number" >= 0)),
    CONSTRAINT "tasks_total_number_check" CHECK (("total_number" > 0)),
...
CREATE TABLE IF NOT EXISTS "public"."teachings" (
    ...
    CONSTRAINT "teachings_type_check" CHECK ((("type")::"text" = ANY ((ARRAY['VIDEO'::character varying, 'AUDIO'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."user_interactions" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "user_interactions_item_type_check" CHECK ((("item_type")::"text" = ANY ((ARRAY['TEACHING'::character varying, 'ARTICLE'::character varying, 'PODCAST_SHOW'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."user_tasks" (
    ...
    "subscribed_quantity" integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."wazifa_gatherings" (
    ...
    "rhythm" "public"."rhythm_level" DEFAULT 'MEDIUM'::"public"."rhythm_level",
...
ALTER TABLE "public"."wazifa_gatherings" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."media_authors"
    ADD CONSTRAINT "media_authors_name_key" UNIQUE ("name");
...
ALTER TABLE ONLY "public"."media_categories"
    ADD CONSTRAINT "media_categories_name_key" UNIQUE ("name");
...
ALTER TABLE ONLY "public"."media_channels"
    ADD CONSTRAINT "media_channels_youtube_id_key" UNIQUE ("youtube_id");
...
ALTER TABLE ONLY "public"."media_videos"
    ADD CONSTRAINT "media_videos_youtube_id_key" UNIQUE ("youtube_id");
...
ALTER TABLE ONLY "public"."silsila_relations"
    ADD CONSTRAINT "silsila_relations_pkey" PRIMARY KEY ("parent_id", "child_id");
...
ALTER TABLE ONLY "public"."user_interactions"
    ADD CONSTRAINT "user_interactions_pkey" PRIMARY KEY ("user_id", "item_id", "item_type");
...
ALTER TABLE ONLY "public"."wazifa_gatherings"
    ADD CONSTRAINT "wazifa_gatherings_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_articles_title_ar_trgm" ON "public"."articles" USING "gin" ("title_ar" "public"."gin_trgm_ops");



CREATE INDEX "idx_articles_title_fr_trgm" ON "public"."articles" USING "gin" ("title_fr" "public"."gin_trgm_ops");
...
CREATE INDEX "idx_campaigns_is_public" ON "public"."campaigns" USING "btree" ("is_public");



CREATE INDEX "idx_media_videos_author" ON "public"."media_videos" USING "btree" ("author_id");



CREATE INDEX "idx_media_videos_category" ON "public"."media_videos" USING "btree" ("category_id");



CREATE INDEX "idx_media_videos_published_at" ON "public"."media_videos" USING "btree" ("published_at" DESC);



CREATE INDEX "idx_media_videos_status" ON "public"."media_videos" USING "btree" ("status");
...
CREATE INDEX "idx_profiles_silsila" ON "public"."profiles" USING "btree" ("silsila_id");



CREATE INDEX "idx_silsila_relations_child" ON "public"."silsila_relations" USING "btree" ("child_id");



CREATE INDEX "idx_silsila_relations_parent" ON "public"."silsila_relations" USING "btree" ("parent_id");



CREATE INDEX "idx_silsilas_level" ON "public"."silsilas" USING "btree" ("level");



CREATE INDEX "idx_silsilas_parent" ON "public"."silsilas" USING "btree" ("parent_id");
...
CREATE INDEX "idx_teachings_author" ON "public"."teachings" USING "btree" ("author_id");



CREATE INDEX "idx_teachings_category" ON "public"."teachings" USING "btree" ("category_id");



CREATE INDEX "idx_teachings_title_ar_trgm" ON "public"."teachings" USING "gin" ("title_ar" "public"."gin_trgm_ops");



CREATE INDEX "idx_teachings_title_fr_trgm" ON "public"."teachings" USING "gin" ("title_fr" "public"."gin_trgm_ops");



CREATE INDEX "idx_user_campaigns_campaign" ON "public"."user_campaigns" USING "btree" ("campaign_id");



CREATE INDEX "idx_user_campaigns_user" ON "public"."user_campaigns" USING "btree" ("user_id");



CREATE INDEX "idx_user_tasks_completed" ON "public"."user_tasks" USING "btree" ("is_completed");



CREATE INDEX "idx_user_tasks_task" ON "public"."user_tasks" USING "btree" ("task_id");



CREATE INDEX "idx_user_tasks_user" ON "public"."user_tasks" USING "btree" ("user_id");
...
ALTER TABLE ONLY "public"."campaigns"
    ADD CONSTRAINT "campaigns_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."media_videos"
    ADD CONSTRAINT "media_videos_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."media_authors"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."media_videos"
    ADD CONSTRAINT "media_videos_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."media_categories"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."media_videos"
    ADD CONSTRAINT "media_videos_channel_id_fkey" FOREIGN KEY ("channel_id") REFERENCES "public"."media_channels"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."podcast_shows"
    ADD CONSTRAINT "podcast_shows_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."authors"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."podcast_shows"
    ADD CONSTRAINT "podcast_shows_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."silsila_relations"
    ADD CONSTRAINT "silsila_relations_child_id_fkey" FOREIGN KEY ("child_id") REFERENCES "public"."silsilas"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."silsila_relations"
    ADD CONSTRAINT "silsila_relations_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."silsilas"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."teachings"
    ADD CONSTRAINT "teachings_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."authors"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."teachings"
    ADD CONSTRAINT "teachings_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."teachings"
    ADD CONSTRAINT "teachings_podcast_show_id_fkey" FOREIGN KEY ("podcast_show_id") REFERENCES "public"."podcast_shows"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."transcripts"
    ADD CONSTRAINT "transcripts_teaching_id_fkey" FOREIGN KEY ("teaching_id") REFERENCES "public"."teachings"("id");
...
ALTER TABLE ONLY "public"."wazifa_gatherings"
    ADD CONSTRAINT "wazifa_gatherings_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;



CREATE POLICY "Admin Full Access" ON "public"."wazifa_gatherings" TO "authenticated" USING ("public"."is_admin"()) WITH CHECK ("public"."is_admin"());



CREATE POLICY "Admin Update Status" ON "public"."wazifa_gatherings" FOR UPDATE USING (true);
...
CREATE POLICY "Auth can manage authors" ON "public"."media_authors" USING (("auth"."role"() = 'authenticated'::"text"));



CREATE POLICY "Auth can manage categories" ON "public"."media_categories" USING (("auth"."role"() = 'authenticated'::"text"));



CREATE POLICY "Auth can manage channels" ON "public"."media_channels" USING (("auth"."role"() = 'authenticated'::"text"));



CREATE POLICY "Auth can manage media" ON "public"."media_videos" USING (("auth"."role"() = 'authenticated'::"text"));



CREATE POLICY "Authenticated Access" ON "public"."wazifa_gatherings" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Authenticated users can create relations" ON "public"."silsila_relations" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Authenticated users can create silsilas" ON "public"."silsilas" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Authenticated users can delete local silsilas" ON "public"."silsilas" FOR DELETE TO "authenticated" USING (("is_global" = false));



CREATE POLICY "Authenticated users can delete relations" ON "public"."silsila_relations" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can update silsilas" ON "public"."silsilas" FOR UPDATE TO "authenticated" USING (true);



CREATE POLICY "Enable delete for authenticated users only" ON "public"."authors" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Enable delete for authenticated users only" ON "public"."podcast_shows" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Enable delete for authenticated users only" ON "public"."teachings" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Enable insert for authenticated users only" ON "public"."authors" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Enable insert for authenticated users only" ON "public"."podcast_shows" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Enable insert for authenticated users only" ON "public"."teachings" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."podcast_shows" FOR SELECT USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."teachings" FOR SELECT USING (true);



CREATE POLICY "Enable update for authenticated users only" ON "public"."authors" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Enable update for authenticated users only" ON "public"."podcast_shows" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Enable update for authenticated users only" ON "public"."teachings" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Everyone can read published videos" ON "public"."media_videos" FOR SELECT USING (("status" = 'PUBLISHED'::"text"));
...
CREATE POLICY "Public can view silsila relations" ON "public"."silsila_relations" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "Public can view silsilas" ON "public"."silsilas" FOR SELECT TO "authenticated", "anon" USING (true);
...
CREATE POLICY "Public podcast_shows are viewable by everyone" ON "public"."podcast_shows" FOR SELECT USING (true);



CREATE POLICY "Public teachings are viewable by everyone" ON "public"."teachings" FOR SELECT USING (true);
...
CREATE POLICY "Super Admin Update Roles" ON "public"."profiles" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "profiles_1"
  WHERE (("profiles_1"."id" = "auth"."uid"()) AND ("profiles_1"."role" = 'SUPER_ADMIN'::"public"."user_role"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles" "profiles_1"
...
CREATE POLICY "Users can update their own profile silsila" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "id")) WITH CHECK (("auth"."uid"() = "id"));
...
CREATE POLICY "tasks_update_creator" ON "public"."tasks" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."campaigns"
  WHERE (("campaigns"."id" = "tasks"."campaign_id") AND ("campaigns"."created_by" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."campaigns"
  WHERE (("campaigns"."id" = "tasks"."campaign_id") AND ("campaigns"."created_by" = "auth"."uid"())))));
...
GRANT ALL ON FUNCTION "public"."add_tasks_to_subscription"("p_user_id" "uuid", "p_campaign_id" "uuid", "p_tasks" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."add_tasks_to_subscription"("p_user_id" "uuid", "p_campaign_id" "uuid", "p_tasks" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_tasks_to_subscription"("p_user_id" "uuid", "p_campaign_id" "uuid", "p_tasks" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_wazifa"("p_name" "text", "p_description" "text", "p_lat" double precision, "p_lng" double precision, "p_rhythm" "public"."rhythm_level", "p_morning" time without time zone, "p_evening" time without time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."create_wazifa"("p_name" "text", "p_description" "text", "p_lat" double precision, "p_lng" double precision, "p_rhythm" "public"."rhythm_level", "p_morning" time without time zone, "p_evening" time without time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_wazifa"("p_name" "text", "p_description" "text", "p_lat" double precision, "p_lng" double precision, "p_rhythm" "public"."rhythm_level", "p_morning" time without time zone, "p_evening" time without time zone) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_nearby_wazifas"("p_lat" double precision, "p_lng" double precision, "radius_meters" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."get_nearby_wazifas"("p_lat" double precision, "p_lng" double precision, "radius_meters" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_nearby_wazifas"("p_lat" double precision, "p_lng" double precision, "radius_meters" double precision) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."insert_test_data"() TO "anon";
GRANT ALL ON FUNCTION "public"."insert_test_data"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."insert_test_data"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."unsubscribe_campaign"("p_campaign_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."unsubscribe_campaign"("p_campaign_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."unsubscribe_campaign"("p_campaign_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."media_channels" TO "anon";
GRANT ALL ON TABLE "public"."media_channels" TO "authenticated";
GRANT ALL ON TABLE "public"."media_channels" TO "service_role";
...
GRANT ALL ON TABLE "public"."podcast_shows" TO "anon";
GRANT ALL ON TABLE "public"."podcast_shows" TO "authenticated";
GRANT ALL ON TABLE "public"."podcast_shows" TO "service_role";
...
GRANT ALL ON TABLE "public"."silsila_relations" TO "anon";
GRANT ALL ON TABLE "public"."silsila_relations" TO "authenticated";
GRANT ALL ON TABLE "public"."silsila_relations" TO "service_role";
...
GRANT ALL ON TABLE "public"."wazifa_gatherings" TO "anon";
GRANT ALL ON TABLE "public"."wazifa_gatherings" TO "authenticated";
GRANT ALL ON TABLE "public"."wazifa_gatherings" TO "service_role";
