...
/// Model representing a Tijani Article/Publication
/// 
...
class TijaniArticle {
  ...
  factory TijaniArticle.fromJson(Map<String, dynamic> json) {
    return TijaniArticle(
      id: json['id'] ?? '',
      title: json['title'] ?? '',
  ...
  @override
  String toString() {
    return 'TijaniArticle(id: $id, title: $title, category: ${category.label})';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is TijaniArticle && other.id == id;
  }
...
enum ArticleCategory {
  teaching('teaching', 'Enseignement', 'تعليم', '📚'),
  biography('biography', 'Biographie', 'السيرة الذاتية', '👤'),
  litany('litany', 'Wird/Litanie', 'ورد', '📿'),
  story('story', 'Récit', 'قصة', '📖'),
  fatwa('fatwa', 'Fatwa', 'فتوى', '⚖️'),
  poem('poem', 'Poème', 'قصيدة', '✍️'),
  dhikr('dhikr', 'Dhikr', 'ذكر', '🌟'),
  dua('dua', 'Dua', 'دعاء', '🤲'),
  wisdom('wisdom', 'Sagesse', 'حكمة', '💡'),
  ...
  const ArticleCategory(this.value, this.label, this.labelAr, this.icon);
  ...
  String get color {
    switch (this) {
      ...
      case ArticleCategory.biography:
        return '#9B7EBD';
      case ArticleCategory.litany:
        return '#D4AF37';
      case ArticleCategory.story:
        return '#3B82F6';
      case ArticleCategory.fatwa:
        return '#EF4444';
      case ArticleCategory.poem:
        return '#EC4899';
      case ArticleCategory.dhikr:
        return '#10B981';
      case ArticleCategory.dua:
        return '#8B5CF6';
      case ArticleCategory.wisdom:
        return '#F59E0B';
      case ArticleCategory.history:
        return '#6366F1';
    }
  }
}
...
enum DifficultyLevel {
  beginner('beginner', 'Débutant', 'مبتدئ'),
  intermediate('intermediate', 'Intermédiaire', 'متوسط'),
  advanced('advanced', 'Avancé', 'متقدم'),
  scholar('scholar', 'Érudit', 'عالم');

  final String value;
  final String label;
  final String labelAr;

  const DifficultyLevel(this.value, this.label, this.labelAr);
