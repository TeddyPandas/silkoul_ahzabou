...
import '../services/tijani_article_service.dart';

/// Provider for managing Tijani Articles state
class TijaniArticleProvider with ChangeNotifier {
  final TijaniArticleService _service = TijaniArticleService();

  // Articles lists
  List<TijaniArticle> _allArticles = [];
  List<TijaniArticle> _featuredArticles = [];
  List<TijaniArticle> _latestArticles = [];
  List<TijaniArticle> _popularArticles = [];
  Map<ArticleCategory, List<TijaniArticle>> _articlesByCategory = {};
  
  // Current article
  TijaniArticle? _currentArticle;
  List<TijaniArticle> _relatedArticles = [];

  // Search & filter
  List<TijaniArticle> _searchResults = [];
  String _searchQuery = '';
  ...
  // Getters
  List<TijaniArticle> get allArticles => _allArticles;
  List<TijaniArticle> get featuredArticles => _featuredArticles;
  List<TijaniArticle> get latestArticles => _latestArticles;
  List<TijaniArticle> get popularArticles => _popularArticles;
  Map<ArticleCategory, List<TijaniArticle>> get articlesByCategory => 
      _articlesByCategory;
  TijaniArticle? get currentArticle => _currentArticle;
  List<TijaniArticle> get relatedArticles => _relatedArticles;
  List<TijaniArticle> get searchResults => _searchResults;
  ...
  Future<void> setCurrentArticle(TijaniArticle article) async {
  ...
  /// Fetch related articles
  Future<void> fetchRelatedArticles(TijaniArticle article) async {
    try {
  ...
  void _updateArticleLikeCount(String articleId, bool increment) {
    void updateList(List<TijaniArticle> list) {
