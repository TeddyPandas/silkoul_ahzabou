...
/// Service for managing Nafahat Articles
class NafahatService {
  ...
  Future<List<NafahatArticle>> getArticles({
    int limit = 20,
    int offset = 0,
    ...
    try {
      ...
      if (category != null) {
        baseQuery = baseQuery.eq('category', category.value);
      }
  ...
  Future<List<NafahatArticle>> getArticlesByCategory(
    ArticleCategory category, {
    int limit = 20,
  }) async {
    try {
  ...
  Future<List<NafahatArticle>> searchArticles(String query) async {
    try {
  ...
  Future<List<NafahatArticle>> getRelatedArticles(
  ...
  Future<List<NafahatArticle>> getArticlesByAuthor(
    String authorId, {
    int limit = 20,
  }) async {
    try {
